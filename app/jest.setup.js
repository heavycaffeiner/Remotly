...
jest.mock('./src/specs/NativeRemotlyFileIO', () => ({
  ...
  default: {
    ...
    pickFolder: resolved(undefined),
    hasFolderAccess: resolved(false),
    findInFolder: resolved(''),
    createInFolder: resolved(''),
